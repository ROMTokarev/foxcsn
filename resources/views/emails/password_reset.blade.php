        ...
        <tbody>
          ...
          <tr>
            <td colspan="2" style="background-color:#fff;padding-left:0;padding-right:0;padding-top:0;padding-bottom:0;" bgcolor="#ffffff" width="100%">
              <a href="https://foxcsn.com/" style="width:100%;" target="_blank" rel=" noopener noreferrer"><img src="https://foxcsn.com/assets/email/pas.jpg" style="width: 600px;" alt="FOXCSN" width="600"></a>
            </td>
          </tr>
 ...
 <table style="background-color:#fcfcfc;width:600px;" class="mceItemTable" cellspacing="0" cellpadding="0" border="0" bgcolor="#fcfcfc" width="600">
        <tbody><tr>
          ...
          <td style="background-color:#347ffb;border-radius:5px 5px 5px 5px;height:50px;text-align:center;" width="280" height="50">
            <div style="font-family:Arial, Helvetica, sans-serif;"><a href="{{ $url }}" style="display:block;text-decoration:none;color:#ffffff;font-size:16px;padding:16px;" target="_blank" rel=" noopener noreferrer">Reset Password</a>
          </div>
        </td>
